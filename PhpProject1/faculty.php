...
require 'db.php';
session_start();
if(isset($_SESSION['fid']) || isset($_SESSION['sid']) )
{
  ...
  <div class="form">
      ...
      <div class="tab-content">
         ...
         <div id="login">   
          ...
          <form action="faculty.php" method="post" autocomplete="off">
          
            <div class="field-wrap">
            <label>
              Faculty ID<span class="req">*</span>
            </label>
            <input type="text" required autocomplete="off" name="fid" style="width: 300px; height:50px;"/>
          </div>
        ...
        <div id="signup">   
          ...
          <div class="field-wrap">
            ...
            <input type="number"required autocomplete="off" name='fid' style="width: 300px; height:50px;"/>
          </div>
