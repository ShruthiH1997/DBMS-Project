...
<div class="dropdown btn-group" >
    ...
    <ul class="dropdown-menu">
    <li><a href="sports.php" class="btn btn-default btn-block">Sports</a></li>
  ...
  <?php
  $q=$mysqli->query("select * from events where winning_house is NULL");
  while($res=$q->fetch_assoc())
  {
      
  ?>
          <li><?=$res['date']?> : <?=$res['event']?></li>
<?php
  }
        ?>
              </ul>
  ...
  <?php
  $q=$mysqli->query("select * from events where winning_house is not NULL");
  while($res=$q->fetch_assoc())
  {
      
  ?>
                 <li><?=$res['date']?> : <?=$res['event']?><br> Winning House: <?=$res['winning_house']?> </li>
<?php
  }
        ?>
              </ul>
